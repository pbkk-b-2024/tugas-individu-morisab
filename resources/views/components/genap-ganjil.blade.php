            ...
            <div
                ...
                <div class="rounded-t mb-0 px-0 border-0">
                    <form action="#" method="POST">
                        @csrf
                        <div class="flex flex-wrap items-center px-4 pt-4 pb-2">
                            <div class="relative w-full max-w-full flex-grow flex-1 flex items-center">
                                <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50 mr-2">Ganjil / Genap
                                </h3>
                    ...
                    <form action="#" method="GET">
                        <div class="flex flex-wrap items-center px-4 pt-2 pb-4">
                            <div class="relative w-full max-w-full flex-grow flex-1 flex items-center">
                                <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50 mr-2">Ganjil / Genap
                                </h3>
                                <input type="text" class="form-input px-3 py-2 rounded border mr-2 text-gray-900"
