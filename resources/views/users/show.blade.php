            ...
            <div
                ...
                <div class="rounded-t mb-0 px-0 border-0">
                    <div class="flex flex-wrap items-center px-4 py-4">
                        <h3 class="font-semibold text-base text-gray-900 dark:text-gray-50">User Details</h3>
                    </div>
                    ...
                    <div class="px-4 py-4">
                        ...
                        <div class="flex justify-between mt-4">
                            <a href="{{ route('users.edit', $user->id) }}"
                                class="bg-yellow-500 text-white px-4 py-2 rounded">Edit User</a>
                            ...
                            <a href="{{ route('users.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Back
                                to List</a>
                        </div>
                    </div>
                </div>
